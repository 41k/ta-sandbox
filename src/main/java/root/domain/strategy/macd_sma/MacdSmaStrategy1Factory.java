...
public class MacdSmaStrategy1Factory extends AbstractStrategyFactory
{
    ...
    public MacdSmaStrategy1Factory(String strategyId, BarSeries series)
    {
    ...
    {
        UpDirectionIndicator longSmaUpDirectionIndicator = new UpDirectionIndicator(longSmaIndicator, 3);
